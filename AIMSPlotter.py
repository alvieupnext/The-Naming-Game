...
#Load the BRUMEG AAL2 functional csv
...
# create_timeseries(brumeg_aal2_functional, consensus_levels, percentage_titles,
#                   'Time Series of Mean Consensus Iterations for Different Levels')

# histogram(brumeg_aal2_functional)

# scatterplot(brumeg_aal2_functional)

# cdf(brumeg_aal2_functional)

# distribution(brumeg_aal2_functional)

# t_test(brumeg_aal2_functional)

fourQuartilesCDF(brumeg_aal2_functional)

# fourQuartilesHistogram(brumeg_aal2_functional)